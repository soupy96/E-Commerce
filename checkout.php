...
$q = "INSERT INTO orders (cust_id, total, order_date) VALUES ($cid, $total, NOW())";
...
if (mysqli_affected_rows($dbc) == 1) {
	...
	// Prepare the query:
	$q = "INSERT INTO order_contents (order_id, prod_id, quantity, price) VALUES (?, ?, ?, ?)";
	...
	if ($affected == count($_SESSION['cart'])) { // Whohoo!
		...
		echo '<p style="color:white;font-family:Source Sans Pro;font-size:2em;padding:2%;">Thank you for your order. You will be notified when the items ship.</p>';
		...
		echo '<p style="color:white;font-family:Source Sans Pro;font-size:2em;padding:2%;">Your order could not be processed due to a system error. You will be contacted in order to have the problem fixed. We apologize for the inconvenience.</p>';
